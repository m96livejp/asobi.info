...
$history = []; // ['start'=>'...', 'end'=>'...', 'status'=>'ok'|'error']
...
<p style="font-size:0.85rem;color:#999;">実行記録がありません。</p>
<?php else: ?>
...
<!-- バックアップ情報 -->
<div style="margin-top:24px;background:#f8f9fe;border:1px solid #dde1f5;border-radius:8px;padding:16px 20px;font-size:0.83rem;color:#3a4a5a;line-height:1.8;">
  ...
  <div>· 毎日 午前5時（Conoha VPX cron）</div>
</div>
