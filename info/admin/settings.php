          ...
          <div class="user-menu">
            <div class="user-trigger" tabindex="0">
              <div class="user-avatar">
                ...
                <?php else: ?>
                  <?= mb_substr($currentUser['display_name'] ?: $currentUser['username'], 0, 1) ?>
                <?php endif; ?>
              </div>
              <span class="user-display-name"><?= htmlspecialchars($currentUser['display_name'] ?: $currentUser['username']) ?></span>
